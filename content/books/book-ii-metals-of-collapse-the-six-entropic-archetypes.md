...
1. **Aluminum Fog** — confusion, diffusion, orientation loss
2. **Copper Tyrant** — volatility, overreaction, mood spikes
3. **Iron Vampire** — oxidative aggression, inner heat, burnout
4. **Manganese Shadow** — doubling, distortion, hall-of-mirrors
5. **Cadmium Grave Digger** — deep stagnation, entombment, emotional burial
6. **Mercury Signal Assassin** — identity flicker, thought-fragmentation, coherence loss
...
1. **Metals loosen.**
2. **Hydra loses structure.**
3. **Collapse no longer self-reinforces.**
...
- geometry and metal  
  to
- **panic architecture** — the symbolic topology of cancer as a subset of Hydra.
