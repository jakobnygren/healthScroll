...
tags = ["health", "niacin", "vitamin-b3", "NAD+", "orthomolecular", "longevity", "detox", "psychiatry"]
+++
...
Today, as research on **NAD+** and **sirtuins** brings niacin back into focus, its legacy reminds us that sometimes _the simplest molecules_ hold the deepest power.  
...
In the early 1950s, psychiatrist **Abram Hoffer** was searching for a nutrient that could stabilize patients with **schizophrenia**. His hypothesis was that an abnormal metabolite, _adrenochrome (oxidized adrenaline)_, was disturbing brain chemistry and producing hallucinations.

While modern evidence has not confirmed adrenochrome as a definitive neurotoxin, Hoffer’s hypothesis framed a groundbreaking biochemical perspective on psychiatric illness that inspired decades of orthomolecular research.


As described in the **Vitamin C chapter**, this imbalance begins upstream in the stress response itself: cortisol and adrenaline rise, but the protective surge of vitamin C never follows. Without ascorbate, adrenaline oxidizes into **adrenochrome**, amplifying oxidative and neurochemical stress. **Niacin**, by replenishing **NAD⁺**, finishes the circuit — metabolizing adrenochrome and stabilizing the redox imbalance left unresolved by vitamin C deficiency. Together, **vitamin C and niacin** form the body’s natural **stress‑response pair**, restoring both chemical and electrical equilibrium.

While modern research has not confirmed adrenochrome as a primary cause of schizophrenia, Hoffer’s framework was pioneering in proposing that psychiatric illness could stem from redox and methylation imbalances rather than purely psychological causes.
...
_“Schizophrenia is not a psychodynamic mystery. It is a biochemical imbalance that can be corrected.” — **Abram Hoffer**_
...
_“It gave me a new lease on life. Within days I felt the depression and anxiety lift.” — **Bill W.**_

### Biochemistry: Niacin and the NAD+ Web

**Niacin** is more than a simple vitamin. It is a **precursor to NAD+ (nicotinamide adenine dinucleotide)**, one of the most central molecules in biology. **NAD+** participates in more than 400 enzymatic reactions, acting as the main electron carrier in the electron transport chain, where mitochondria generate **ATP**. It is also consumed by enzymes that repair **DNA**, regulate **inflammation**, and activate **sirtuins** — the so-called longevity regulators.
...
Because **niacin** sits further upstream, its conversion to **NAD+** is naturally **rate-limited**. This means the body maintains control, preventing runaway effects. By contrast, **NMN** and **NR** feed in further downstream, bypassing some feedback control points. While this can make NAD+ restoration more rapid, it also raises open questions about long-term metabolic regulation — one reason niacin remains the most physiologically balanced and time-tested option.
...
_“Orthomolecular medicine is the treatment of disease by the provision of the optimum molecular environment, especially for the brain.” — **Linus Pauling**_
...
_“NAD+ is the closest we’ve gotten to a fountain of youth. When levels go up, cells think they’re young again.” — **David Sinclair**_
...
While older trials demonstrated impressive improvements in HDL and triglycerides, later large-scale studies using sustained-release forms combined with statins (e.g., _AIM-HIGH_, _HPS2-THRIVE_) failed to improve outcomes. These used formulations and combinations that differ from Hoffer’s approach, highlighting how form and context determine results.

The characteristic **“flush”** from niacin is not a side effect but a **physiological signal** — a prostaglandin-mediated dilation of capillaries that improves blood flow and microcirculation.
...
_“If it doesn’t flush, it doesn’t work.” — **Abram Hoffer**_
...
Another unique property of **niacin** is its ability to **mobilize fatty acids from adipose tissue**. This has been used in **detoxification protocols** combining niacin with sauna therapy to support the mobilization of fat-soluble toxins like **PCBs, dioxins, and pesticides**. While the evidence base for toxin clearance remains debated, niacin’s role in lipid mobilization and hepatic metabolism is well established.

Controlled studies on detoxification are limited, yet mechanistic data show niacin’s activation of lipolysis and improvement in liver enzyme profiles, particularly when combined with antioxidants and hydration.
...
Case reports describe hepatotoxicity mainly at 3–9 g/day, typically with sustained intake or pre-existing liver strain; doses ≤1.5 g/day are generally regarded as safe.
...
_**Niacin** supplies NAD+ for energy and redox reactions, powering phagocytosis, the oxidative burst, and balanced immune signaling._  

**Reduced cytokine storms:** Lowers excessive inflammatory signaling that can damage tissues.  
_Through the **GPR109A (HCAR2) receptor** and **sirtuin activation**, niacin helps calm overproduction of pro-inflammatory cytokines like **TNF-α** and **IL-6**._  

**DNA repair support:** Provides **NAD+** for enzymes that maintain genome stability under stress.  
_**PARP enzymes** require NAD+ to repair DNA damage during infection and inflammation; niacin keeps this pathway active._  
...
**Core Cofactors** (_Essential_, _Always Paired_)  
...
_“Mental illness is usually biochemical illness. Schizophrenia is vitamin B-3 (niacin) dependency. [But] patients are given drugs and released. The new mental hospital today is the streets.” — **Abram Hoffer**_
...
_See **Cofactor Protocol** section above for details on essential nutrient supports._
...
_**Monitoring tip:** For gram-level use, check liver enzymes (ALT/AST) at baseline and again after 6–8 weeks (earlier if symptoms arise)._
...
- **Liver safety:** Immediate-release niacin above ~500 mg/day can cause **transient, asymptomatic ALT/AST elevations**; serious injury is uncommon. Risk increases at gram doses and is disproportionately associated with **sustained/extended-release products** or with switching from immediate- to sustained-release forms. **Nicotinamide** is generally well tolerated up to ~1–1.5 g/day, but **hepatotoxicity has been reported at ≥3 g/day** (and occasionally at lower doses in specific populations). Prefer **immediate-release niacin** and **monitor liver enzymes** during high-dose therapy.  
  Routine monitoring of liver enzymes (ALT/AST) is recommended when using doses above 1.5 g/day for longer than 6–8 weeks.
  Transient, mild enzyme elevations can occur early in therapy and usually resolve spontaneously, but persistent elevations warrant dose adjustment or discontinuation.
...
Some of Hoffer’s patients described recovery not just as a reduction in hallucinations, but as a profound _return of clarity_, as if a veil had lifted from their minds. **Niacin’s role goes beyond neutralizing a toxin; it restores the integrity of the brain’s signal, stabilizing its chemistry and renewing its flow of energy. As NAD+ levels rise, the brain’s capacity for steady function is restored with renewed clarity and resilience.**

**Niacin is more than a vitamin. It serves as a methyl acceptor that stabilizes brain chemistry, a precursor to NAD+ that fuels mitochondrial energy production and DNA repair, a vascular dilator that enhances circulation, a detox activator that mobilizes lipid-stored toxins, and a psychiatric ally supporting recovery in many cases of schizophrenia and addiction.** 

What began as Hoffer’s search for a psychiatric tool may, in retrospect, be one of the most powerful _metabolic correctors_ of the 20th century — still overlooked, still underestimated.
...
_“When you give the body what it is missing, the symptoms vanish, not because they are suppressed, but because they no longer need to exist.” — **Abram Hoffer**_
...
**2025-10-13**
- Added clarifying note on adrenochrome hypothesis (historical vs. modern evidence).
- Refined NAD+ pathway explanation for balance between niacin and NMN/NR.
- Expanded detox section with clarification on evidence base and hepatic mechanisms.
- Updated liver-safety notes to describe transient enzyme elevations.
- Added this revision log for transparency and version tracking.
